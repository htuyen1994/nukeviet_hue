...
elseif( $op != 'setup' )
{
	...
	$sql_drop_module[] = 'DROP TABLE IF EXISTS ' . $db_config['prefix'] . '_' . $module_data . '_updateprice';
	$set_lang_data = '';
}
...
$sql_create_module[] = "CREATE TABLE IF NOT EXISTS " . $db_config['prefix'] . "_" . $module_data . "_updateprice (
